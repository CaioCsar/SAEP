...
--
-- Host: 127.0.0.1
-- Generation Time: 20-Set-2023 às 02:17
...
CREATE TABLE `alocacao` (
  ...
  `automovel` int(2) DEFAULT NULL,
  `concessionária` int(2) DEFAULT NULL,
...
CREATE TABLE `concessionarias` (
  `id` int(2) NOT NULL,
  `concessionária` varchar(24) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
ALTER TABLE `alocacao`
  ADD PRIMARY KEY (`id`),
  ADD KEY `concessionária` (`concessionária`),
...
--
ALTER TABLE `alocacao`
  ADD CONSTRAINT `alocacao_ibfk_1` FOREIGN KEY (`concessionária`) REFERENCES `concessionarias` (`id`),
  ADD CONSTRAINT `alocacao_ibfk_2` FOREIGN KEY (`automovel`) REFERENCES `automoveis` (`id`);

--
-- Limitadores para a tabela `concessionarias`
--
ALTER TABLE `concessionarias`
  ADD CONSTRAINT `concessionarias_ibfk_1` FOREIGN KEY (`id`) REFERENCES `clientes` (`Id`);
COMMIT;
